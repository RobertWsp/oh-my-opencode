...
let STALL_DETECT_POLL_COUNT = 60
...
export function __setTimingConfig(overrides: Partial<ReturnType<typeof getTimingConfig>>): void {
  ...
  if (overrides.STALL_DETECT_POLL_COUNT !== undefined) STALL_DETECT_POLL_COUNT = overrides.STALL_DETECT_POLL_COUNT
}
